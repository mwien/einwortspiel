defmodule EinwortspielWeb.GameLive.Standings do
  ...
  def render(assigns) do
    ...
    ~H"""
    <EinwortspielWeb.CoreComponents.table id="standings" rows={Map.keys(@scores)}>
    ...
    </EinwortspielWeb.CoreComponents.table>
    """
  end
